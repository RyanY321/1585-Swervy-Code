...
//  private final AnalogInput ultrasonic = new AnalogInput(0); //the 0 represents the Analog port number we’ve connected our sensor to.
  ...
  private final int desiredDriveTime = 3000;
  private final int desiredDumpTime = 5000;
  private final double autoDumpBeltSpeed = 1.0;
  ...
  public void robotInit() {
    ...
    startAutomaticCapture = CameraServer.getInstance().startAutomaticCapture();
  }
